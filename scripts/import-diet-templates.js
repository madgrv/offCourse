// Script to import diet plan templates to the database
// Follows nutrition guidelines where carbohydrates and sugars are stored separately
// and carbohydrates already include sugars (as per standard nutrition labels)
  ...
  try {
    ...
    for (const [dayName, dayData] of Object.entries(dietPlan.days)) {
      ...
      for (const [mealType, foods] of Object.entries(dayData.meals)) {
        ...
        console.log(`Created all food items for ${mealType}`);
      }
    }
